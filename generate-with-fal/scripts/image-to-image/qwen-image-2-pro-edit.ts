...
const ENDPOINT_ID = "fal-ai/qwen-image-2/pro/edit";
const TOOL_NAME = "qwen-image-2-pro-edit";

async function main() {
  const args = parseToolArgs(
    {
      prompt: { type: "string", short: "p", required: true, desc: "Text prompt to edit the image (supports Chinese)" },
    ...
    {
      scriptName: "qwen-image-2-pro-edit.ts",
      toolName: TOOL_NAME,
      description: "Qwen Image 2 Pro Edit - Image-to-Image Editing",
      examples: [
        'bun qwen-image-2-pro-edit.ts --prompt "Make this scene summer setting" --image "https://example.com/photo.png"',
        'bun qwen-image-2-pro-edit.ts --prompt "Use image 1 style on image 2" --image "style.png,content.png"',
      ],
    }
  );
