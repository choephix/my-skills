...
const ENDPOINT_ID = "fal-ai/flux-2-pro/edit";
const TOOL_NAME = "flux-2-pro-edit";

async function main() {
  const args = parseToolArgs(
    {
      prompt: { type: "string", short: "p", required: true, desc: "The text prompt to edit the image" },
      image: { type: "images", short: "i", required: true, desc: "Image URL(s) to edit (comma-separated)" },
      seed: { type: "int", desc: "Random seed for reproducibility" },
      size: { type: "size", presets: FLUX_SIZES_WITH_AUTO, default: "auto", desc: "Image size preset or custom WxH" },
