...
const ENDPOINT_ID = "fal-ai/qwen-image-2/text-to-image";
const TOOL_NAME = "qwen-image-2";
...
async function main() {
  const args = parseToolArgs(
    ...
    {
      scriptName: "qwen-image-2.ts",
      toolName: TOOL_NAME,
      description: "Qwen Image 2 - Text-to-Image Generation",
      examples: [
        'bun qwen-image-2.ts --prompt "A cyberpunk city at night"',
        'bun qwen-image-2.ts --prompt "可爱的熊猫在吃竹子" --size square --seed 12345',
      ],
    }
  );
