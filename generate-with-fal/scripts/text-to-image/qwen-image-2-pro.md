# Qwen Image 2 Pro - Text-to-Image Generation

Qwen-Image-2.0 Pro is a next-generation foundational unified generation-and-editing model with enhanced quality. Supports Chinese and English prompts.

## Quick Usage

```bash
bun qwen-image-2-pro.ts --prompt "A sunset over mountains"
```
...
# Chinese prompt
bun qwen-image-2-pro.ts --prompt "可爱的熊猫在吃竹子"

# With negative prompt
bun qwen-image-2-pro.ts --prompt "A forest" --negative "blurry, low quality"

# Complex infographic (Pro handles long prompts well)
bun qwen-image-2-pro.ts --prompt "A detailed infographic showing the water cycle..."
```

## API Reference

https://fal.ai/models/fal-ai/qwen-image-2/pro/text-to-image/api
